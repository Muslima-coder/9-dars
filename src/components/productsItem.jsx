...
function ProductItem ({item}) {
    return (
        <div className="w-[302px] rounded-md  shadow-lg shadow-slate-300 p-[25px] ">
            <img className="!mb-[25px] rounded-md" src={item.img} alt="img" width={302} height={458} />
           ...
           <div className="flex justify-between items-center">
            ...
            <div className="mx-auto flex items-center justify-center w-[40px] h-[40px] rounded-full bg-[rgba(246,246,246,1)] ">
